...
"""
.. module:: luther.config
    :platform: Unix
    :synopsis: Configuration for luther.
...
# Database URI
SQLALCHEMY_DATABASE_URI = 'sqlite:///luther.db'
# Flask secret key
...
# Subdomains restricted from being added by users
...
LOG_FILE_PATH = '/var/log/luther.log'
